# MINIK 1.67.0 Beta 70 auf GitHub testen
...
5. Der Workflow führt `npm ci`, **433 automatisierte Tests**, den Release-Preflight, den Produktionsbuild und die Offline-Verifikation einschließlich aller persönlichen Sprachclips aus.
