# MINIK 1.68.0 Beta 71 auf GitHub testen
...
5. Der Workflow führt `npm ci`, die vollständige automatisierte Testsuite, den Release-Preflight, den Produktionsbuild und die Offline-Verifikation einschließlich der gebündelten Sprachdateien aus.
