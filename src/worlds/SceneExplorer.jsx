...
export default function SceneExplorer({ items, worldId, lang, settings, found = [], speakingId = null, onDiscover, onMino, outfit, hint = 0, paused = false, interactionBlocked = () => false, footer }) {
  ...
  >
    ...
    >
      {items.map((item, index) => {
        ...
        return <div className="discovery-slide" key={item.id} aria-hidden={index !== pager.index}>
          <button
